...
public class CAPModel extends GenericModel{  
	 ...
	 */
	def this (sizeProblem : Long, seed : Long, opts:ParamManager) : CAPModel(sizeProblem) {
...
public type CAPModel(s:Long)=CAPModel{self.sz==s};
